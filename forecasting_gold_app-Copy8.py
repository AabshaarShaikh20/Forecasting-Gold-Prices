...
st.markdown(
    ...
    /* Background Image */
    .stApp {
        background-image: url('https://png.pngtree.com/background/20231030/original/pngtree-d-render-of-the-stock-market-s-golden-chart-or-illustration-picture-image_5800117.jpg');
